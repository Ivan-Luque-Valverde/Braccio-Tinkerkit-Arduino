...
: ${AMENT_CURRENT_PREFIX:="/home/ivan/Escritorio/Braccio-Tinkerkit-Arduino/install/braccio_description"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/braccio_description/environment/pythonpath.sh"
